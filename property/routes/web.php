...
Route::get('search/{par1}', 'App\Http\Controllers\Home@search');
Route::get('search2/{par1}', 'App\Http\Controllers\Home@search_kontraktor');
Route::get('properti/{par1}/{slug?}', 'App\Http\Controllers\Home@properti');
Route::get('proyek/{par1}/{slug?}', 'App\Http\Controllers\Home@proyek');
Route::get('agent/{par1}', 'App\Http\Controllers\Home@agent');
...
Route::get('about_project', 'App\Http\Controllers\Home@about_project');
Route::get('aksi', 'App\Http\Controllers\Aksi@index');
Route::get('aksi/status/{par1}', 'App\Http\Controllers\Aksi@status');

Route::get('listing/location', 'App\Http\Controllers\Listing@location');
// Login
...
Route::get('admin/konfigurasi/profil_kontraktor', 'App\Http\Controllers\Admin\Konfigurasi@profil_kontraktor');
...
Route::post('admin/konfigurasi/proses_profil_kontraktor', 'App\Http\Controllers\Admin\Konfigurasi@proses_profil_kontraktor');
// berita
...
// kategori_property
Route::get('admin/kategori_property', 'App\Http\Controllers\Admin\Kategori_property@index');
Route::post('admin/kategori_property/tambah', 'App\Http\Controllers\Admin\Kategori_property@tambah');
Route::post('admin/kategori_property/edit', 'App\Http\Controllers\Admin\Kategori_property@edit');
Route::get('admin/kategori_property/delete/{par1}', 'App\Http\Controllers\Admin\Kategori_property@delete');
// kategori_agenda
...
// Property
Route::get('admin/property', 'App\Http\Controllers\Admin\Property@index');
Route::get('admin/property/cari', 'App\Http\Controllers\Admin\Property@cari');
Route::get('admin/property/kategori/{par1}', 'App\Http\Controllers\Admin\Property@kategori');
Route::get('admin/property/detail/{par1}', 'App\Http\Controllers\Admin\Property@detail');
Route::get('admin/property/tambah', 'App\Http\Controllers\Admin\Property@tambah');
Route::get('admin/property/edit/{par1}', 'App\Http\Controllers\Admin\Property@edit');
Route::get('admin/property/delete/{par1}', 'App\Http\Controllers\Admin\Property@delete');
Route::post('admin/property/tambah_proses', 'App\Http\Controllers\Admin\Property@tambah_proses');
Route::post('admin/property/edit_proses', 'App\Http\Controllers\Admin\Property@edit_proses');
Route::post('admin/property/proses', 'App\Http\Controllers\Admin\Property@proses');
// site
...
// dataset
Route::get('admin/dataset/kabupaten/{provinsiId}', 'App\Http\Controllers\Admin\Dataset@kabupaten');
Route::get('admin/dataset/kecamatan/{kabupatenId}', 'App\Http\Controllers\Admin\Dataset@kecamatan');
