...
<div class="row form-group" style="{{ (($berita->jenis_berita!='Berita') ? 'display:none;' : '') }}">
...
<div class="row form-group">
  ...
  <div class="col-md-6">
    <input type="text" name="link_berita" class="form-control form-control-lg" placeholder="Link <?php if(isset($_GET['jenis_berita'])) { echo $_GET['jenis_berita']; }else{ echo 'Berita'; } ?>" value="{{ $berita->link_berita }}">
  </div>
</div>
<?php } ?>
