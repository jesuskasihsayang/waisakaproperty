...
<div class="row form-group">
  <?php if(isset($_GET['jenis_berita'])) { ?>
  <label class="col-md-3 text-right">Isi Ringkas</label>
  <?php }else{ ?>
...
<?php if(isset($_GET['jenis_berita'])) { ?>
<input type="hidden" name="isi" value="$_GET['jenis_berita']">
<?php }else{ ?>
<div class="row form-group">
...
<div class="row form-group" style="{{ (isset($_GET['jenis_berita']) ? 'display:none;' : '') }}">
...
<div class="row form-group" >
  ...
  <div class="col-md-6">
    <input type="text" name="link_berita" class="form-control form-control-lg" placeholder="Link <?php if(isset($_GET['jenis_berita'])) { echo $_GET['jenis_berita']; }else{ echo 'Berita'; } ?>" value="{{ old('link_berita') }}">
  </div>
</div>
<?php } ?>
