...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    {{ csrf_field() }}
    <?php 
      if(Request::segment(3)=="jenis_berita") { 
    ...
    <div class="input-group">                  
      <input type="text" name="keywords" class="form-control" placeholder="Ketik kata kunci..." value="<?php if(isset($_GET['keywords'])) { echo strip_tags($_GET['keywords']); } ?>" required style="{{ $display }}">
      <span class="input-group-btn btn-flat">
        <button type="submit" class="btn btn-info" style="{{ $display }}"><i class="fa fa-search"></i> Cari</button>
