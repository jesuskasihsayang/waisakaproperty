...
<div class="col-md-6">
    ...
    <div class="form-group">
    <label>URL Tiktok <i class="fa fa-tiktok"></i></label>
   <input type="text" name="tiktok" placeholder="http://tiktok.com/namakamu" value="<?php echo $site->tiktok ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Tiktok <i class="fa fa-facebook"></i></label>
    <input type="text" name="nama_tiktok" placeholder="Nama akun tiktok" value="<?php echo $site->nama_tiktok ?>" class="form-control">
    </div>
    ...
    <input type="text" name="youtube" placeholder="http://youtube.com/namakamu" value="<?php echo $site->youtube ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Youtube <i class="fa fa-youtube"></i></label>
    <input type="text" name="nama_youtube" placeholder="Nama akun youtube" value="<?php echo $site->nama_youtube ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>URL Linkedin <i class="fa fa-linkedin"></i></label>
    <input type="text" name="linkedin" placeholder="http://linkedin.com/namakamu" value="<?php echo $site->linkedin ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Linkedin <i class="fa fa-linkedin"></i></label>
    <input type="text" name="nama_linkedin" placeholder="Nama akun linkedin" value="<?php echo $site->nama_linkedin ?>" class="form-control">
    </div>
