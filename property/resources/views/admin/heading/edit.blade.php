...
<div class="form-group row">
	...
	<div class="col-md-9">
		<select name="halaman" class="form-control">
			...
			<option value="About" <?php if($heading->halaman=="About") { echo 'selected'; } ?>>Tentang Kami</option>
			<option value="Search" <?php if($heading->halaman=="Search") { echo 'selected'; } ?>>Halaman Pencarian</option>
