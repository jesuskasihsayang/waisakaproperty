...
<div class="row form-group">
  ...
  <div class="col-md-9">
  <input type="text" name="nickname_staff" class="form-control" placeholder="Nama Panggilan" value="{{ old('nickname_staff') }}" required>
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-9">
  <input type="text" name="nama_staff" class="form-control" placeholder="Nama Lengkap" value="{{ old('nama_staff') }}" required>
  </div>
</div>
