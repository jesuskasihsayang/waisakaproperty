  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ asset('panduan') }}" target="_blank" class="nav-link" style="display:none;"><i class="fa fa-file-pdf"></i> Panduan</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block" style="display:none;">
        <a href="{{ asset('/') }}" target="_blank" class="nav-link" style="display:none;"><i class="fa fa-home"></i> Beranda</a>
      </li>
    </ul>
