...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
   <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"> <a class="nav-link" href="{{ asset('about_project') }}">Kontraktor</a>
      ...
      <li class="nav-item"> <a class="nav-link" href="{{ asset('search/jual?order=newest&limit=9') }}">Properti Dijual</a>
      <li class="nav-item"> <a class="nav-link" href="{{ asset('search/sewa?order=newest&limit=9') }}">Properti Disewakan</a>
