   ...
   <div class="container">
         ...
         <div class="col-md-3 col-sm-6">
            <div class="footer-widget">
               ...
               <ul class="lastest-products">
                  ...
                  <li><img src="{{ asset('assets/upload/image/thumbs/'.$nav_layananf->gambar) }}" alt="{{ $nav_layananf->judul_berita }}"> <strong><a href="{{ $nav_layananf->link_berita }}">{{ $nav_layananf->judul_berita }}</a></strong> <span class="pdate"><i>Updated:</i> <?php echo tanggal('tanggal_id',$nav_layananf->tanggal_post) ?></span> </li>
                  <?php } ?>
               </ul>
            </div>
         </div>
         ...
         <div class="col-md-3 col-sm-12">
            <div class="footer-widget">
               ...
               <div class="footer-social">
                  ...
                  <a href="{{ $site_config->linkedin }}"><i class="fab fa-linkedin-in"></i></a> 
                  <a href="{{ $site_config->instagram }}"><i class="fab fa-instagram"></i></a> 
                  <a href="{{ $site_config->youtube }}"><i class="fab fa-youtube"></i></a> </div>
            </div>
         </div>
         <!--Footer Widget End--> 
      </div>
      <div class="row footer-copyr">
         ...
         <div class="col-md-8 col-sm-8">
               <p><a target="_blank" href="{{ asset('/') }}">{{ $site_config->namaweb }}</a></p>
            </div>
      </div>
   </div>
</footer>
